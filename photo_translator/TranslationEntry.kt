package com.example.translation.logic
...
class TranslationEntry : UniversalAppEntrySimple {
    override val id: String = "translation_demo"
    override val displayName: String = "Translation Demo"
    ...
    override fun commands(): List<UniversalCommand> {
        val translate = object : UniversalCommand {
            override val id: String = "translate"
            override val title: String = "Translate"
